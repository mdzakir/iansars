...
--
-- Host: localhost
-- Generation Time: Dec 11, 2013 at 01:39 AM
...
CREATE TABLE IF NOT EXISTS `insr_activities` (
  ...
  `viewer` varchar(50) DEFAULT NULL COMMENT 'who can view this log -> if null can be viewed by both super admin and admin',
  `is_deleted` tinyint(2) NOT NULL DEFAULT '0',
  `created_at` datetime NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Admin and super admin can view the summary of all activities' AUTO_INCREMENT=4 ;

--
-- Dumping data for table `insr_activities`
--

INSERT INTO `insr_activities` (`id`, `message`, `viewer`, `is_deleted`, `created_at`, `updated_at`) VALUES
(1, 'Daee [[{"href":"/daee/1","daee":"1"}]] has edited his profile', NULL, 0, '2013-09-22 22:20:13', '2013-09-22 16:50:13'),
(2, 'Daee [[{"href":"/daee/1","daee":"1"}]] has edited his profile', NULL, 0, '2013-12-11 01:14:28', '2013-12-10 19:44:28'),
(3, 'Daee [[{"href":"/daee/1","daee":"1"}]] has edited his profile', NULL, 0, '2013-12-11 01:14:58', '2013-12-10 19:44:58');
...
INSERT INTO `insr_callers_profile` (`id`, `caller_id`, `first_name`, `last_name`, `family_name`, `nick_name`, `gender`, `date_of_birth`, `email_id`, `social_network_id`, `messenger_id`, `house_no`, `street`, `area`, `city`, `state`, `country`, `zip`, `primary_phone`, `secondary_phone`, `highest_education`, `profession`, `type_of_user`, `profile_pic`, `languages_known`, `callee_created`, `callee_owned`, `can_own_cnt`, `unassigned_madhoo`, `can_invite`, `can_hide`, `organization`, `created_at`, `updated_at`) VALUES
(1, 1, 'Super', 'Admin', 'Superrr', 'Admin', 'MALE', '1986-01-15', 'iansarmail@gmail.com', '{"facebook":"dmdfaisal","Twitter":"dmdfaisal"}', '{"gtalk":"dmdfaisal@gmail.com","skypeid":"dmdfaisal"}', '', '', 'Shivajinagar', 'Bangalore', 'Karnataka', 'India', 560001, '9739135891', '', 'B.Tech(IT)', 'Software Engineer', 'DAEE', '1377712350_Desertjpg.png', '["Tamil","English","Urdu","Kannada"]', '', '[{"id":"1","update_at":"\\"2013-08-28 00:09:26\\""}]', 16, NULL, 1, 1, '["2","3"]', '2012-12-23 00:03:22', '2013-12-10 19:44:58'),
(4, 4, 'Muhammad', 'Zakir', 'Muhammad', 'Zakir', 'MALE', '1986-07-13', 'mdzakir.com@gmail.com', '{"facebook":"yahoobook"}', '{"skypeid":"amdzakir"}', '', '', 'Funworld', 'Bangalore', 'Karnataka', 'India', 560001, '7204180050', '', 'B.E(IS)', 'Software Engineer', NULL, '1377713152_Lighthousejpg.png', '["Kannada","English","Hindi"]', '[{"id":"11","update_at":"\\"2013-09-08 06:45:29\\""}]', NULL, 6, NULL, 1, 1, NULL, '2013-08-28 12:05:53', '2013-09-22 10:50:02'),
(5, 5, 'MD', 'Zakir', 'MD', 'Zakir', 'MALE', '1986-07-14', 'amdzakir@outlook.com', '{"facebook":"yahoobook"}', '{"skypeid":"amdzakir"}', '', '', 'Funworld', 'Bangalore', 'Karnataka', 'India', 560001, '7204180050', '', 'B.E(IS)', 'Software Engineer', NULL, '1377798104_Tulipsjpg.png', '["Kannada","English","Hindi"]', '[{"id":"10","update_at":"\\"2013-09-08 06:38:06\\""}]', NULL, 5, NULL, 0, 0, NULL, '2013-08-29 11:41:44', '2013-09-22 06:55:19'),
(6, 6, 'Faisal', 'Dokku', 'Dokku', 'Faisal', 'MALE', '1982-12-15', 'dmdfaisal@gmail.com', '{"":""}', '{"gtalk":"dmdfaisal","skypeid":"dmdfaisal"}', '31/1-2', 'Hospital Road', 'Shivajinagar', 'Bangalore', 'Karnataka', 'India', 560001, '97455076910', '97455076910', 'B.Com', 'System Analyst - IT', NULL, '1378112486_Lighthousejpg.png', '["English","Urdu","Hindi","Tamil","Arabic"]', NULL, NULL, 5, NULL, 0, 0, NULL, '2013-09-02 03:01:26', '2013-09-02 09:02:14'),
(7, 7, 'Irshad', 'Mohammed', '', '', 'MALE', '1981-01-20', 'irsh.arsh@gmail.com', '[]', '{"gtalk":"irsh.ppc@gmail.com"}', '', '', 'Tolichowki', 'Hyderabad', 'Andhra Pradesh', 'India', 500008, '9885390877', '', 'MBA', 'Business', NULL, '1378184585_islamicjpg.png', '["English","urdu"]', '[{"id":"3","update_at":"\\"2013-09-03 21:35:59\\""}]', NULL, 5, NULL, 0, 0, NULL, '2013-09-02 22:52:23', '2013-09-04 03:35:59'),
(8, 8, 'Uzair', 'Ahmed', 'Ansari', 'Uzair', 'MALE', '1983-06-08', 'iansartest1@outlook.com', '{"GooglePlus":"iansartest1"}', '{"skypeid":"iansartest1"}', '', '', 'RT Nagar', 'Bangalore', 'Karnataka', 'India', 560032, '7204180050', '', 'BA, LLB', 'Practicing lawyer', NULL, '1378490522_Koalajpg.png', '["English","Hindi","Tamil"]', '[{"id":"4","update_at":"\\"2013-09-06 12:07:43\\""}]', NULL, 5, NULL, 0, 0, NULL, '2013-09-06 12:02:02', '2013-09-06 18:07:43'),
(9, 9, 'Nazeer', 'Mohammed', 'Baig', 'Nazeer', 'MALE', '1981-12-17', 'iansartest2@outlook.com', '{"LinkedIn":"iansartest2","facebook":"iansartest2","GooglePlus":"iansartest2"}', '{"hotmailmessenger":"iansartest2"}', '', '', 'Ejipura', 'Bangalore', 'Karnataka', 'India', 560095, '7204180050', '', 'MBA', 'HR Manager', NULL, '1378491288_Hydrangeasjpg.png', '["English","Urdu","Hindi","Kannada","Telugu"]', '[{"id":"6","update_at":"\\"2013-09-06 12:27:27\\""}]', NULL, 5, NULL, 1, 0, NULL, '2013-09-06 12:14:49', '2013-09-08 11:02:44'),
(10, 10, 'Mohamed', 'Yusuf', 'Khudri', 'Yusuf', 'MALE', '1985-05-14', 'iansartest3@outlook.com', '{"facebook":"iansartest3"}', '{"yahoomessenger":"iansartest3"}', '', '', 'ChamundiNagar', 'Bangalore', 'Karnataka', 'India', 560033, '7204180050', '', 'BCA', 'Tech Specialist at PQRST', NULL, '1378492591_Jellyfishjpg.png', '["English","Kannada","Urdu","Hindi"]', '[{"id":"9","update_at":"\\"2013-09-08 06:23:20\\""}]', NULL, 5, NULL, 0, 0, NULL, '2013-09-06 12:36:31', '2013-09-08 12:23:20'),
(11, 11, 'Owes', 'Hussain', 'Mysoori', 'Owes', 'MALE', '1984-03-21', 'iansartest6@outlook.com', '{"facebook":"iansartest6","LinkedIn":"iansartest6","Pinterest":"iansartest6"}', '{"hotmailmessenger":"iansartest6","yahoomessenger":"iansartest6","skypeid":"iansartest6"}', '', '', 'Hegde Nagar', 'Bangalore', 'Karnataka', 'India', 560016, '3191445565', '', 'B.A Fine Arts', 'Artist Professor at FNARTS', NULL, '1378577501_Hydrangeasjpg.png', '["English","Tamil","Urdu"]', '[{"id":"8","update_at":"\\"2013-09-08 06:18:17\\""}]', NULL, 5, NULL, 0, 0, NULL, '2013-09-07 12:11:41', '2013-09-08 12:18:17'),
(12, 12, 'Sadiq', 'Ahmed', 'Syed', 'Sadiq', 'MALE', '1983-06-13', 'iansartest7@outlook.com', '{"GooglePlus":"iansartest7"}', '{"yahoomessenger":"iansartest7"}', '', '', 'Yeshwantpur', 'Bangalore', 'Karnataka', 'India', 560055, '8455965656', '', 'BAMC', 'Doctor - Own clinic', NULL, '1378638419_Jellyfishjpg.png', '["English","Kannada","Telugu","Tamil","Hindi"]', '[{"id":"7","update_at":"\\"2013-09-08 05:11:29\\""}]', NULL, 5, NULL, 0, 0, NULL, '2013-09-08 05:06:59', '2013-09-08 11:11:29');
...
--
-- Table structure for table `insr_organizations`
--

CREATE TABLE IF NOT EXISTS `insr_organizations` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `insr_organizations`
--

INSERT INTO `insr_organizations` (`id`, `name`, `type`, `address`, `state`, `country`, `contact_number`, `created_by`, `is_deleted`, `deleted_by`, `created_at`, `updated_at`) VALUES
(2, 'New org', 'GROUP', '#90, 2nd street, gurgon', 'Delhi', 'India', '9876567890', 1, 0, 1, '2013-12-10 23:11:52', '2013-12-10 19:31:15'),
(3, 'new one', 'ORGANIZATION', 'lajsd;lfjsd', 'sadlj;sdfk', 'lja;lsdjflsd', '976890', 1, 0, NULL, '2013-12-11 00:54:24', '2013-12-10 19:24:24');
...
('ueq9gco6nm201hpl6fh0at8fc3', 1386707323, );
...
--
-- Constraints for table `insr_organizations`
--
ALTER TABLE `insr_organizations`
  ADD CONSTRAINT `insr_organizations_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `insr_callers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `insr_organizations_ibfk_2` FOREIGN KEY (`deleted_by`) REFERENCES `insr_callers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
