...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('callee_created')); ?>:</b>
	<?php echo CHtml::encode($data->callee_created); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('callee_owned')); ?>:</b>
	<?php echo CHtml::encode($data->callee_owned); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('can_own_cnt')); ?>:</b>
	<?php echo CHtml::encode($data->can_own_cnt); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('unassigned_madhoo')); ?>:</b>
	<?php echo CHtml::encode($data->unassigned_madhoo); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('can_invite')); ?>:</b>
	<?php echo CHtml::encode($data->can_invite); ?>
	<br />
