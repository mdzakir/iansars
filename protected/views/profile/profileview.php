...
<div class="dashBoard">
	<div class="dashBoardName leftDB">
			...
			<fieldset>
				...
				<table>
					<tr>
						...
						<td class="dbData"><span><?php echo $model->house_no.$model->house_no?', ':''.$model->street.$model->street?', ':''.$model->area; ?></span></td>
					</tr>
					<tr class="separatorDB"><td colspan="2"><hr></td></tr>
					<tr>
		...
		<div class="dbBoxContainer mt10i">
			<fieldset>
				<legend>Organizations/Groups</legend>
				<table>
					<tr>
						<td class="dbData">
							<span><?php if($orgNames) { echo $orgNames; ?>
							<?php } ?></span>
						</td>
					</tr>
					<tr class="separatorDB"><td colspan="2"><hr></td></tr>
