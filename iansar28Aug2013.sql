...
--
-- Host: localhost
-- Generation Time: Aug 28, 2013 at 12:30 AM
...
CREATE TABLE IF NOT EXISTS `insr_admin_messages` (
  ...
  KEY `read_by` (`read_by`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Messages to admin' AUTO_INCREMENT=3 ;

--
-- Dumping data for table `insr_admin_messages`
--

INSERT INTO `insr_admin_messages` (`id`, `sender_id`, `type`, `status`, `target_caller_id`, `title`, `message`, `read_by`, `created_at`, `updated_at`) VALUES
(1, 1, 'ADMIN_SPAM', 'UNREAD', 3, 'Reporting Spammer in iAnsar', 'Reason is just like that I want to test things!', NULL, '2013-08-13 23:29:35', '2013-08-13 17:59:35'),
(2, 1, 'ADMIN_SPAM', 'DELETED', 2, 'Reporting Spammer in iAnsar', 'reported spammer for testing', NULL, '2013-08-14 00:02:45', '2013-08-13 19:00:25');
...
(1, 1, 2, NULL, 'Some', 'Name', 'Family', 'Nick', 'MALE', 37, 'M.E', 'SE', 'No.45', 'North Car street', 'Mandaveli', 'Chennai', 'Tamilnadu', 'India', 62000, 'tamil, english', 'tamil, english', 'tamil, english', 'buddh', 'some@some.com', '343393948433', '{"facebook":"fb", "Twitter":"tweeting"}', '{"hotmailmessenger":"msn"}', 'NO_INTERACTION_YET', 'Name of madhoo is so and so. Name of madhoo is so and so \r\nName of madhoo is so and so \r\nName of madhoo is so and so Name of madhoo is so and so Name of madhoo is so and so Name of madhoo is so and so Name of madhoo is so and so Name of madhoo is so and so Name of madhoo is so and so Name of madhoo is so and so Name of madhoo is so and so , Name of madhoo is so and so ', '2013-08-28', 0, '0', '2013-01-13 17:02:35', '2013-08-27 18:39:26'),
(2, 1, NULL, NULL, 'new amad', 'ljads', 'l;ad', 'adskfjladsf', 'FEMALE', 24, 'M.E', 'SE', 'No.45', '2nd Cross', 'Mandaveli', 'Bangalore', 'Karnataka', 'India', 560092, 'some lang', 'some lang', 'some lang', 'somethig', 'jebin@jebin.com', '919535872103', '{"facebook":"jebinbv"}', '{"gtalk":"gtalkjebin"}', 'DISAGREED', 'hai', '2013-06-01', 0, '0', '2013-01-19 19:43:01', '2013-08-03 13:57:29'),
(3, 1, 1, NULL, 'new amad1', 'de Banville', 'Family', 'adskfjladsf', 'FEMALE', 24, 'M.Er', 'SEr', 'No.45', '2nd Cross', 'Mandaveli', 'Bangalore', 'Tamilnadu', 'India', 560092, 'some lang', 'tamil, english', 'some lang', 'somethig', 'name@name.com', '919535872103', '{"facebook":"jebinbv"}', '{"gtalk":"gtalkjebin"}', 'NO_INTERACTION_YET', NULL, '2013-08-22', 0, '0', '2013-01-19 12:36:41', '2013-08-22 17:48:54'),
(4, 1, NULL, '["1"]', 'Blah', 'Blah', 'Blah', 'Blah', 'FEMALE', 21, 'B.tech', 'Doctor', '123', 'bah', 'blah', 'blah', 'blah', 'blah', 13333333, 'benglali', 'hidi', 'english', 'blah', 'balh@hlah.com', '234345643', '{"Twitter":"blah@twitter.com"}', '{"hotmailmessenger":"bal@hotmail.com"}', 'CONVINCED', NULL, NULL, 0, '0', '2013-04-20 16:43:00', '2013-08-03 13:57:29'),
(6, 1, NULL, NULL, 'Madhoo 1', 'Mahoo', 'Ma', 'hoo', 'MALE', 22, 'MBA', 'HR', '210', '23 b', 'Valalar area', 'Vellore', 'Tamilnadu', 'India', 965673, 'Tamil', 'Tamil', 'Tamil', 'Buddha', 'some@some.com', '929384747473', '{"MySpace":"madhoo@myspace.com"}', '{"skypeid":"madhoo","AIM":"madhoo"}', 'DISAGREED', 'some note', '2013-06-01', 1, '0', '2013-05-30 23:22:59', '2013-08-03 13:57:29');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Da''ee registration & login lookup table' AUTO_INCREMENT=4 ;
...
(2, 'admin', 'jebin@itvillage.fr', 'cc81b0da820d482462750439d6c06411', 1, 1, '[{"1":"3"},{"1":"1"}]', '2013-01-24 00:00:00', '2013-08-13 19:23:29'),
(3, NULL, 'bvjebin@yahoo.com', 'c05dfce210c7d759ea6218a9132ea978', 1, 1, NULL, '2013-06-01 00:00:00', '2013-08-13 18:11:05');
...
(1, 1, 'Jebin', 'BV', 'Benjamin', 'Jebin', 'MALE', '1990-01-26', 'iansarmail@gmail.com', '{"facebook":"JebinBv","Twitter":"jebin19"}', '{"gtalk":"bvjebin@gmail.com","AIM":"jebin@aio.com"}', '', '', '', 'Bangalore', 'Karnataka', 'India', 560092, '9535872103', '', 'B.Tech(IT)', 'Software Engineer', 'DAEE', '1358256602_2012_11_05_113343jpg.png', '["Tamil","English"]', '', '[{"id":"1","update_at":"\\"2013-08-28 00:09:26\\""}]', 16, NULL, 1, 1, '2012-12-23 00:03:22', '2013-08-27 18:39:26'),
(2, 2, 'jebin', 'raj', 'ben', 'jamin', 'MALE', '1992-05-26', 'jebin@itvillage.fr', '{"facebook":"jebinraj"}', '{"msn":"jebinraj"}', 'No.45', 'North Car street', 'Mandaveli', 'Chennai', 'Tamilnadu', 'India', 62000, '233453245443', NULL, 'M.tech', 'Lect', 'Da''ee', 'none', '["tamil","english"]', NULL, NULL, 8, NULL, 1, 1, '2013-01-19 20:47:46', '2013-08-02 16:36:48'),
(3, 3, 'Md ', 'Ali', 'Ashraf', 'Jaffar', 'MALE', '1988-11-16', 'bvjebin@yahoo.com', '{"Twitter":"mdali898"}', '{"":""}', '', '', '', 'City', 'state', 'Country', 34543, '9856789876567', '98767897656789', 'M.Tech', 'Lawyer', NULL, '1370109251_myAvatarjpg.png', '["English","Tamil"]', NULL, NULL, 5, NULL, 1, 0, '2013-06-01 23:24:11', '2013-07-23 17:05:07');
...
(1, 'bvjebin@gmail.com', 1, '0b1b77b190345aefd08041386a5b662a', 0, 1, '2013-04-27 23:55:54', '2013-08-23 19:42:24');
...
(2, 1, 1, 'ADMIN_WARN', 'DELETED', 'WARNING !!!', 'You are misusing the system. This warning is the last.', '0000-00-00 00:00:00', '2013-08-23 16:57:07'),
(3, 1, 2, 'ADMIN_WARN', 'READ', 'WARNING !!!', 'warn me', '0000-00-00 00:00:00', '2013-08-19 18:35:58'),
...
(33, 1, 1, 'MESSAGE', 'READ', 'Title message', 'Message from sender!', '2013-05-25 22:53:21', '2013-08-19 18:37:43'),
(34, 1, 1, 'MESSAGE', 'READ', 'Mess tit', 'Message for you', '2013-05-25 22:54:38', '2013-08-19 18:37:47'),
(35, 1, 2, 'MESSAGE', 'DELETED', 'new tit', 'new message', '2013-05-25 22:55:13', '2013-08-23 18:37:44'),
(36, 1, 2, 'MESSAGE', 'DELETED', 'ok', 'ok', '2013-05-25 22:55:45', '2013-08-23 18:32:37'),
(37, 1, 2, 'MESSAGE', 'DELETED', 'message no', 'message yes', '2013-05-25 22:57:12', '2013-08-23 18:32:37'),
(38, 1, 2, 'MESSAGE', 'DELETED', 'send message fromd etaill page', 'page detaila', '2013-05-25 23:07:05', '2013-08-23 18:32:37'),
...
(43, 1, 1, 'ASSIGNMENT_UNRESPONDED_NOTIFY_ADMIN', 'UNREAD', 'Request for a Madhoo remains unresponded', 'Request of Daee [[{\\"href\\":\\"/madhoo/viewmadhoo/1\\",\\"daee\\":\\"1\\"}]] for the Madhoo [[{\\"href\\":\\"/madhoo/viewmadhoo/2\\",\\"madhoo\\":\\"2\\"}]] of Daee(Created and Owned Daee) [[{\\"href\\":\\"/daee/2\\",\\"daee\\":\\"2\\"}]]<br />[[{\\"href\\":\\"/madhoo/approverequest/1?status=yes\\",\\"value\\":\\"Approve\\",\\"className\\":\\"approve_req\\"}]][[{\\"href\\":\\"/madhoo/rejectrequest/1?status=no\\",\\"value\\":\\"Ignore\\",\\"className\\":\\"reject_req\\"}]]', '2013-06-01 18:31:20', '2013-06-01 13:01:20'),
(44, 1, 1, 'UNASSIGNED_FAILED_RENEWAL', 'READ', 'Madhoo Unassigned', 'This is to inform you that the Madhoo [[{"href":"/madhoo/viewmadhoo/1","madhoo":"1"}]] created by has been unassigned and released to general madhoo pool.', '2013-06-01 18:45:32', '2013-08-21 18:31:46'),
(45, 1, 1, 'UNASSIGNED_FAILED_RENEWAL', 'UNREAD', 'Madhoo Unassigned', 'This is to inform you about that the Madhoo [[{"href":"/madhoo/viewmadhoo/1","madhoo":"1"}]] on or before 2013-03-25 is released to general pool as you failed to renew the madhoo', '2013-06-01 18:45:32', '2013-06-01 13:40:32'),
(46, 1, 1, 'ASSIGNMENT_UNRESPONDED_NOTIFY_ADMIN', 'UNREAD', 'Request for a Madhoo remains unresponded', 'Request of Daee [[{"href":"/madhoo/viewmadhoo/1","daee":"1"}]] for the Madhoo [[{"href":"/madhoo/viewmadhoo/2","madhoo":"2"}]] of Daee(Created and Owned Daee) [[{"href":"/daee/2","daee":"2"}]]<br />[[{"href":"/madhoo/approverequest/1?status=yes","value":"Approve","className":"approve_req"}]][[{"href":"/madhoo/rejectrequest/1?status=no","value":"Ignore","className":"reject_req"}]]', '2013-06-01 21:24:19', '2013-06-01 15:54:19'),
(47, 1, 1, 'ASSIGNMENT_UNRESPONDED_NOTIFY_ADMIN', 'UNREAD', 'Request for a Madhoo remains unresponded', 'Request of Daee [[{"href":"/madhoo/viewmadhoo/1","daee":"1"}]] for the Madhoo [[{"href":"/madhoo/viewmadhoo/2","madhoo":"2"}]] of Daee(Created and Owned Daee) [[{"href":"/daee/2","daee":"2"}]]<br />[[{"href":"/madhoo/approverequest/1?status=yes","value":"Approve","className":"approve_req"}]][[{"href":"/madhoo/rejectrequest/1?status=no","value":"Ignore","className":"reject_req"}]]', '2013-06-01 21:27:32', '2013-06-01 15:57:32'),
(48, 1, 1, 'ASSIGNMENT_SUCCESSFUL', 'UNREAD', 'Madhoo Assigned successfully', 'Madhoo assignment successfull. <br />[[{"href":"/madhoo/viewmadhoo/2","value":"View Madhoo"}]]<br />Let Allah be with you', '2013-06-01 23:28:25', '2013-06-01 18:20:42'),
(51, 2, 1, 'ASSIGNMENT', 'READ', 'Assign Madhoo to Me', 'I have interest in Madhoo <a target="_blank" class="fancyLink" href="/madhoo/viewothermadhoo/6"><b>Madhoo 1 Mahoo</b></a>. Assign him to me<br />[[{"href":"/madhoo/approverequest/2?status=yes","value":"Approve","className":"approve_req"}]][[{"href":"/madhoo/rejectrequest/2?status=no","value":"Ignore","className":"reject_req"}]]', '2013-06-01 23:40:18', '2013-06-01 18:20:52'),
(52, 2, 1, 'ASSIGNMENT_CC', 'READ', 'Assign Madhoo to Me', 'I have interest in Madhoo <a target="_blank" class="fancyLink" href="/madhoo/viewothermadhoo/6"><b>Madhoo 1 Mahoo</b></a>. Assign him to me<br />[[{"href":"/madhoo/approverequest/2?status=yes","value":"Approve","className":"approve_req"}]][[{"href":"/madhoo/rejectrequest/2?status=no","value":"Ignore","className":"reject_req"}]]', '2013-06-01 23:40:18', '2013-06-01 18:20:58'),
(54, 1, 2, 'ASSIGNMENT_SUCCESSFUL', 'UNREAD', 'Request for Madhoo Approved', 'The requested Madhoo [[{"href":"/madhoo/viewmadhoo/6","madhoo":"6"}]] is approved to you successfully.', '2013-06-01 23:56:10', '2013-06-01 18:26:10'),
(57, 1, 1, 'ASSIGNMENT', 'UNREAD', 'Assign Madhoo to Me', 'I have interest in Madhoo [[{"href"="/madhoo/viewothermadhoo/1","madhoo":1}]]. Assign him to me<br />[[{"href":"/madhoo/approverequest/5?status=yes","value":"Approve","className":"approve_req"}]][[{"href":"/madhoo/rejectrequest/5?status=no","value":"Ignore","className":"reject_req"}]]', '2013-06-16 20:18:58', '2013-06-16 14:48:58'),
(58, 1, 2, 'ASSIGNMENT', 'READ', 'Assign Madhoo to Me', 'I have interest in Madhoo [[{"href"="/madhoo/viewothermadhoo/1","madhoo":1}]]. Assign him to me<br />[[{"href":"/madhoo/approverequest/5?status=yes","value":"Approve","className":"approve_req"}]][[{"href":"/madhoo/rejectrequest/5?status=no","value":"Ignore","className":"reject_req"}]]', '2013-06-16 20:18:58', '2013-06-16 14:49:54'),
(59, 1, 1, 'ASSIGNMENT_CC', 'UNREAD', 'Assign Madhoo to Me', 'I have interest in Madhoo [[{"href"="/madhoo/viewothermadhoo/1","madhoo":1}]]. Assign him to me<br />[[{"href":"/madhoo/approverequest/5?status=yes","value":"Approve","className":"approve_req"}]][[{"href":"/madhoo/rejectrequest/5?status=no","value":"Ignore","className":"reject_req"}]]', '2013-06-16 20:18:58', '2013-06-16 14:48:58'),
(60, 1, 2, 'ASSIGNMENT_SUCCESSFUL', 'UNREAD', 'Request for Madhoo Approved', 'The requested Madhoo [[{"href":"/madhoo/viewmadhoo/1","madhoo":"1"}]] is approved to you successfully.', '2013-08-28 00:09:26', '2013-08-27 18:39:26');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='All assignment and approval request should have entry here' AUTO_INCREMENT=7 ;
...
(1, 2, 2, 2, 2, NULL, NULL, 'UNREAD', 'UNREAD', NULL, 0, '2013-05-27 00:00:00', '2013-05-26 18:30:00'),
(2, 6, 1, NULL, 2, 1, 'APPROVED', 'DELETED', 'UNREAD', NULL, 0, '2013-06-01 23:40:18', '2013-08-23 17:05:30'),
(5, 1, 1, NULL, 2, 1, 'APPROVED', 'READ', 'UNREAD', NULL, 0, '2013-06-16 20:18:58', '2013-08-27 18:39:26'),
(6, 3, 1, NULL, 2, 1, 'APPROVED', 'READ', 'UNREAD', NULL, 0, '2013-08-22 23:18:54', '2013-08-24 07:54:14');
...
('jjagfdveds62r7pts2shnhq226', 1377631314, );
